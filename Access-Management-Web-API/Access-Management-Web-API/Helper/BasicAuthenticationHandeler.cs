...
namespace Access_Management_Web_API.Helper
{
    ...
    {
        private readonly LarnDataContext context;
        public BasicAuthenticationHandeler(IOptionsMonitor<AuthenticationSchemeOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock, LarnDataContext context) : base(options, logger, encoder, clock)
        {
